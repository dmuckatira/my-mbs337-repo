...
parser.add_argument(
    ...
    required=True,
    default=cif_file,
    help=f'path to input mmCIF file (default: {cif_file})'
    )
...
parser.add_argument(
    ...
    required=False,
    default=output_json,
    help=f'path to output JSON file (default: {output_json})'
    )
...
def summarize_cif_file(cif_file: str) -> CifSummary:
    """
...
def main():
    ...
    try:
        summary = summarize_cif_file(args.input)
